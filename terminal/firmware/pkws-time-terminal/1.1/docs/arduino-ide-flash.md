# Firmware 1.1.4 mit Arduino IDE flashen
...
- Das LCD muss `pkws-time-terminal-v1.1.4` anzeigen. Im Bereitschaftsbild zeigt die vierte Zeile nach NTP die lokale Europe/Berlin-Zeit; vor NTP steht dort `--.--.---- --:--`.
