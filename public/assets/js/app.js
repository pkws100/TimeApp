(function () {
    ...
    function personnelLabelBadge(label) {
        const color = safePersonnelColor(label.color || '#2563eb', '#2563eb');
        ...
        return '<span class="app-personnel-label" style="--app-personnel-label-color:' + escapeHtml(color) + '">'
            + '<strong>' + personnelIconSvg(icon) + '<span>' + escapeHtml(name) + '</span></strong>'
            + description
            + '</span>';
    }

    function personnelIconSvg(icon) {
        const key = normalizePersonnelIconKey(icon || 'award');
        const icons = {
            award: '<circle cx="12" cy="8" r="5"></circle><path d="M8.21 13.89 7 22l5-3 5 3-1.21-8.11"></path>',
            medal: '<circle cx="12" cy="8" r="5"></circle><path d="M8.21 13.89 7 22l5-3 5 3-1.21-8.11"></path>',
            'medal-star': '<circle cx="12" cy="8" r="5"></circle><path d="M8.21 13.89 7 22l5-3 5 3-1.21-8.11"></path>',
            certificate: '<circle cx="12" cy="8" r="5"></circle><path d="M8.21 13.89 7 22l5-3 5 3-1.21-8.11"></path>',
            ...
            tool: '<path d="M14.7 6.3a4 4 0 0 0-5 5L3 18l3 3 6.7-6.7a4 4 0 0 0 5-5l-2.6 2.6-3-3 2.6-2.6Z"></path>',
            ...
            'calendar-days': '<path d="M8 2v4"></path><path d="M16 2v4"></path><rect x="3" y="4" width="18" height="18" rx="2"></rect><path d="M3 10h18"></path>',
            calendar: '<path d="M8 2v4"></path><path d="M16 2v4"></path><rect x="3" y="4" width="18" height="18" rx="2"></rect><path d="M3 10h18"></path>',
            shield: '<path d="M20 13c0 5-3.5 7.5-7.3 8.8a2 2 0 0 1-1.4 0C7.5 20.5 4 18 4 13V5l8-3 8 3Z"></path><path d="m9 12 2 2 4-4"></path>',
            'shield-check': '<path d="M20 13c0 5-3.5 7.5-7.3 8.8a2 2 0 0 1-1.4 0C7.5 20.5 4 18 4 13V5l8-3 8 3Z"></path><path d="m9 12 2 2 4-4"></path>',
            'hard-hat': '<path d="M2 18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2"></path><path d="M10 10V5a2 2 0 0 1 4 0v5"></path><path d="M4 18v-2a8 8 0 0 1 16 0v2"></path>',
            'helmet-safety': '<path d="M2 18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2"></path><path d="M10 10V5a2 2 0 0 1 4 0v5"></path><path d="M4 18v-2a8 8 0 0 1 16 0v2"></path>',
            'id-card': '<rect x="3" y="4" width="18" height="16" rx="2"></rect><circle cx="9" cy="10" r="2"></circle><path d="M15 9h3"></path><path d="M15 13h3"></path><path d="M7 16h4"></path>',
            badge: '<rect x="3" y="4" width="18" height="16" rx="2"></rect><circle cx="9" cy="10" r="2"></circle><path d="M15 9h3"></path><path d="M15 13h3"></path><path d="M7 16h4"></path>',
        ...
        const fallback = '<path d="M20.59 13.41 11.17 4H4v7.17l9.41 9.42a2 2 0 0 0 2.83 0l4.35-4.35a2 2 0 0 0 0-2.83Z"></path><path d="M7.5 7.5h.01"></path>';

        return '<span class="app-personnel-label__icon" aria-hidden="true"><svg viewBox="0 0 24 24" focusable="false">' + (icons[key] || fallback) + '</svg></span>';
    }

    function normalizePersonnelIconKey(icon) {
        return String(icon || '')
            .trim()
            .toLowerCase()
            .replace(/_/g, '-')
            .replace(/^(?:(?:fa-solid|fa-regular|fa-light|fa-duotone|fa-brands|fas|far|fal|fad|fab|fa)-)+/, '')
            .replace(/[^a-z0-9-]+/g, '-')
            .replace(/^-+|-+$/g, '');
    }

    function safePersonnelColor(color, fallback) {
