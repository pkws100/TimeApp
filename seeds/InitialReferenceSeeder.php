...
final class InitialReferenceSeeder extends AbstractSeed
{
    ...
    public static function permissions(): array
    {
        return [
            ...
            ['code' => 'time_accounts.view', 'label' => 'Zeitkonten ansehen', 'scope' => 'timesheets'],
            ['code' => 'time_accounts.manage', 'label' => 'Zeitkonten verwalten', 'scope' => 'timesheets'],
            ['code' => 'vacation_requests.view', 'label' => 'Urlaubsantraege ansehen', 'scope' => 'timesheets'],
            ['code' => 'vacation_requests.manage', 'label' => 'Urlaubsantraege verwalten', 'scope' => 'timesheets'],
